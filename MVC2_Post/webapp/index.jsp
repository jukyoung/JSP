...
<body>
	 <button type="button" id="toInput" class="btn btn-outline-success">toInput</button>
     <button type="button" id="toOutput" class="btn btn-outline-warning">toOutput</button>
